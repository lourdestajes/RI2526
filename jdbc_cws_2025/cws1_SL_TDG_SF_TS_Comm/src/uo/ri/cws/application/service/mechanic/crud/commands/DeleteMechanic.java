...
public class DeleteMechanic implements Command<Void> {
	...
	public DeleteMechanic(String idMechanic) {
		ArgumentChecks.isNotEmpty(idMechanic, "The mechanic id cant be null or empty");
	...
	private void chekkIfMechanicHasInterventions(String id) throws BusinessException {
		BusinessChecks.isTrue(iGat.findByMechanicId(id).isEmpty(),
				"The mechanic with id " + idMechanic + " cannot be deleted because it has associated work orders");
	}

	private void checkIfMechanicHasWorkOrders(String id) throws BusinessException {
		BusinessChecks.isTrue(woGat.findByMechanicId(id).isEmpty(),
				"The mechanic with id " + idMechanic + " cannot be deleted because it has associated work orders");
	}

	private void checkIfMechanicExists(String id) throws BusinessException {
		BusinessChecks.isTrue(mGat.findById(id).isPresent(), "The mechanic with id " + id + " does not exist");
