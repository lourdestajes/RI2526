...
import uo.ri.cws.application.service.invoice.create.commands.FindUnpaidAmount;
...
public class InvoicingServiceImpl implements InvoicingService {
    ...
    @Override
    public List<InvoiceDto> findInvoicesByVehicle(String plate)
            throws BusinessException {
        return executor.execute(new FindInvoicesByVehiclePlate(plate));
    }

    @Override
    public double findNotYetPaidAmount() throws BusinessException {
        return executor.execute(new FindUnpaidAmount());
    }
