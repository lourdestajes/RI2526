...
import uo.ri.cws.application.service.mechanic.crud.commands.CalculateTimeOnInterventionsCommand;
...
import uo.ri.cws.application.service.mechanic.crud.commands.FindMechanicsWithWageGreaterThan;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
	...
	@Override
	public int calculateTimeOnInterventions(String mechanicId) throws BusinessException {
		return executor.execute(new CalculateTimeOnInterventionsCommand(mechanicId));
	}


	@Override
	public List<MechanicDto> findBaseWageGreaterThan(double amount) throws BusinessException {
		return executor.execute(new FindMechanicsWithWageGreaterThan(amount));
	}
