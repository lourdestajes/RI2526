...
public class ContractsMenu extends BaseMenu {
    {
        menuOptions = new Object[][] { { "Administrator > Contract management", null },

                { "List mechanics", NotYetImplementedAction.class }, { "Add contract", AddContractAction.class },
                { "Update contract", UpdateContractAction.class }, { "Delete contract", DeleteContractAction.class },
