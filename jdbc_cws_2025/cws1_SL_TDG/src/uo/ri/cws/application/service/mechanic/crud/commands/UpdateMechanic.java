...
public class UpdateMechanic {
    ...
    public UpdateMechanic(MechanicDto mechanic) {
        ...
        ArgumentChecks
                .isNotBlank(mechanic.id, "The mechanic id cannot be null");
        ArgumentChecks
                .isNotBlank(mechanic.nif, "The mechanic nif cannot be null");
        ArgumentChecks
                .isNotBlank(mechanic.name, "The mechanic name cannot be null");
        ArgumentChecks.isNotBlank(
                mechanic.surname, "The mechanic surname cannot be null");
    ...
    public void execute() throws BusinessException {
        ...
        BusinessChecks.hasVersion(
                received.version, readFromDatabase.version, "Staled data");
